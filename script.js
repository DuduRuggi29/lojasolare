...
function selectVariant(element, type) {
    ...
    if (type === 'light') {
        ...
        if (val === 'warm') {
            updateMainImage('luminaria-warm.webp', document.querySelector('.thumb:nth-child(1)'));
        } else {
            updateMainImage('luminaria-white.webp', document.querySelector('.thumb:nth-child(2)'));
        }
    }
}
